...
void CachedSurface::LoadGLBuffer(RasterizerTemporalMemory& res_cache_tmp_mem) {
...
void CachedSurface::FlushGLBuffer(RasterizerTemporalMemory& res_cache_tmp_mem) {
...
void CachedSurface::UploadGLMipmapTexture(RasterizerTemporalMemory& res_cache_tmp_mem, u32 mip_map,
...
void CachedSurface::UploadGLTexture(RasterizerTemporalMemory& res_cache_tmp_mem,
                                    GLuint read_fb_handle, GLuint draw_fb_handle) {
