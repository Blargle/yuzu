...
struct RasterizerTemporalMemory {
...
public:
    ...
    void LoadGLBuffer(RasterizerTemporalMemory& res_cache_tmp_mem);
    void FlushGLBuffer(RasterizerTemporalMemory& res_cache_tmp_mem);

    // Upload data in gl_buffer to this surface's texture
    void UploadGLTexture(RasterizerTemporalMemory& res_cache_tmp_mem, GLuint read_fb_handle,
...
private:
    void UploadGLMipmapTexture(RasterizerTemporalMemory& res_cache_tmp_mem, u32 mip_map,
...
private:
    ...
    RasterizerTemporalMemory temporal_memory;
